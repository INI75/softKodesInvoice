...
class _ClientsListState extends State<ClientsList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        backgroundColor: Colors.white,
        body: Container(
            child: ListView(children: [ClientListField(), ClientDataField()])),
...
class ClientListField extends StatefulWidget {
  const ClientListField({Key? key}) : super(key: key);

  @override
  _ClientListFieldState createState() => _ClientListFieldState();
}

class _ClientListFieldState extends State<ClientListField> {
  @override
  Widget build(BuildContext context) {
    return AnimatedContainer(
      duration: Duration(seconds: 5),
      curve: Curves.bounceInOut,
      height: change ? MediaQuery.of(context).size.height * 1 : 0,
      child: Padding(
...
//
class ClientDataField extends StatefulWidget {
  const ClientDataField({Key? key}) : super(key: key);

  @override
  _ClientDataFieldState createState() => _ClientDataFieldState();
}

class _ClientDataFieldState extends State<ClientDataField> {
  @override
  Widget build(BuildContext context) {
    return AnimatedContainer(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Column(
        children: [
          ClientEdit(
              icon: Icons.mail_outline, title: 'Email', text: _clientEmail),
          ClientEdit(
